    ...
    <div className="p-0 pb-12 mb-8 bg-gray-200 rounded-lg shadow-lg lg:p-8 ">
      <div className="relative mb-6 overflow-hidden shadow-md pb-80">
        <img
          ...
          alt={post.title}
          className="object-top absolute h-80 object-cover  w-full rounded-t-lg shadow-lg  lg:rounded-lg"
        />
      </div>
      ...
      <div className="text-center ">
          <Link href={`/post/${post.slug}`}>
              <span className="inline-block px-8 py-3 text-lg font-medium text-gray-200 transition-all transform bg-pink-600 rounded-full shadow-lg cursor-pointer hover:-translate-y-1 hover:shadow-none hover:bg-pink-700">
                  Continue Reading
              </span>
          </Link>
      </div>
